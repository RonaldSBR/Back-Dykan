...
async function create(req, res) {
  try {
    const { picture, nickname, email, password, age } = req.body;

    if (!picture || !nickname || !email || !password || !age) {
...
async function update(req, res) {
  try {
    ...
    usuarioEncontrado.picture =
      req.body.picture || usuarioEncontrado.picture;
    usuarioEncontrado.nickname =
      req.body.nickname || usuarioEncontrado.nickname;
